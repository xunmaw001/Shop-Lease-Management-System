            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">商铺出租展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="chuzuName" id="chuzuName" placeholder="商铺名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <select name="chuzuTypes" id="chuzuTypes" lay-filter="chuzuTypes">
                                  <option value="">--请选择--</option>
                                  <option v-for="item in chuzuTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                              </select>
                          </div>
                      </div>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            var chuzuTypes = $("#chuzuTypes").find("option:selected").val();
            if (chuzuTypes != null && chuzuTypes != "" && chuzuTypes != "null") {
                param['chuzuTypes'] = chuzuTypes;
            }
                                    // 获取列表数据
    ...
    // 当前表的字典表
       ...
       function chuzuTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=chuzu_types", 'get', {}, function (res) {
               if(res.code == 0){
                   vue.chuzuTypesList = res.data.list;
               }
           });
       }
