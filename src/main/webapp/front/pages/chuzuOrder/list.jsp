...
<div id="app">
    ...
    <div class="line-container">
        <p class="line" style="background: #EEEEEE;"> 我的商铺出租订单 </p>
    </div>
    <!-- 标题 -->
        ...
        <div class="right-container" style="padding-top: 0;">
            <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                <ul class="layui-tab-title">
                    <li v-for="item in shenheTypesList" :value="item.codeIndex"  @click="pageList(item.codeIndex)">{{item.indexName}}</li>
                </ul>
                <div class="layui-tab-content">
                    <table class="layui-table" lay-skin="nob">
                        ...
                        <tr v-for="(item,index) in dataList" v-bind:key="index">
                            ...
                            <td style="width: 80px;">{{item.chuzuValue}}</td>
                            <td style="width: 150px;">{{item.chuzuOrderDay}}</td>
                            <td style="width: 80px;">{{item.shenheValue}}</td>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
       ...
       function shenheTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=shenhe_types", 'get', {}, function (res) {
               if(res.code == 0){
