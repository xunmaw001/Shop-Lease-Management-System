              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">租赁时间/月:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="chuzuOrderDay" id="chuzuOrderDay"  lay-verify="integer|required"   placeholder="租赁时间/月" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">审核:</span>
                        <div class="layui-input-inline">
                            <select name="shenheTypes" id="shenheTypes" lay-filter="shenheTypes" style="width: 600px;">
                                <option v-for="item in shenheTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                            </select>
                        </div>
                    </div>
                </div>
